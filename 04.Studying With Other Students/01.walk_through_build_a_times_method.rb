...
#3) Excecution continues to line 4. The `while` conditional is  evaluated. The first time through, the condition is true.
...
#7) Reaching the end of the blcok, execution continues back to the `times` method implemetation on line 6, where the `counter` is incremented.
#8) Reaching the end of the `while` loop, execution continues on line 4, essentialy repeating steps 3 through 7. 
...
#10) Reaching the end of the method at line 10, execution will return the last expression in this method, which is the `number`
#
